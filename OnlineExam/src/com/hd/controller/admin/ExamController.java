...
import com.hd.page.admin.Page;
import com.hd.service.admin.ExamService;
import com.hd.service.admin.QuestionService;
...
public class ExamController {
	...
	public Map<String, String> add(Exam exam){
		...
		if(exam.getSingleQuestionNum() > singleQuestionTotalNum){
			ret.put("type", "error");
			ret.put("msg", "单选题数量超过题库单选题总数，请修改!题刻总数量"+singleQuestionTotalNum);
			return ret;
		}
		//获取多选题总数
		...
		if(exam.getMuiltQuestionNum() > muiltQuestionTotalNum){
			ret.put("type", "error");
			ret.put("msg", "多选题数量超过题库多选题总数，请修改!题库数量为"+muiltQuestionTotalNum);
			return ret;
		}
		//获取判断题总数
		...
		if(exam.getChargeQuestionNum() > chargeQuestionTotalNum){
			ret.put("type", "error");
			ret.put("msg", "判断题数量超过题库判断题总数，请修改!题库总数量为"+chargeQuestionTotalNum);
			return ret;
		}
